...
define(['mediator', 'lib/utils', 'controllers/application_controller', 'models/user', 'lib/services/facebook', 'views/login_view'], function(mediator, utils, ApplicationController, User, Facebook, LoginView) {
  'use strict';
