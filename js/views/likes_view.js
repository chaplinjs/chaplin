...
define(['mediator', 'views/collection_view', 'views/compact_like_view', 'text!templates/likes.hbs'], function(mediator, ChaplinCollectionView, CompactLikeView, template) {
  'use strict';
