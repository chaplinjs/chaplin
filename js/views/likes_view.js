...
define(['mediator', 'views/application_collection_view', 'views/compact_like_view', 'text!templates/likes.hbs'], function(mediator, ApplicationCollectionView, CompactLikeView, template) {
  'use strict';
